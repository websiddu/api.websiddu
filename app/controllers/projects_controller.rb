class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.permit(:title, :id, :date, :sequence, :votes, :projectUrl, :isActive, :slug, :description, :shortDescription, :tags, :skills, :thumbnail, :banner, :screenshots, :size, :archived)
    end
end
